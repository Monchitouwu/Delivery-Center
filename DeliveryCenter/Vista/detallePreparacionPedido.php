...
<meta charset="utf-8">
        ...
        <title>Detalle preparacion de pedido</title>
		...
		<div class="card text-center">
			...
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<label class="col-sm-3 col-form-label"><strong>Notas agregadas del pedido</strong></label>
					
                </div>
                <div class="form-group row">
				
                
                    <input type="text" class="form-control" placeholder="Notas ingresadas" readonly>
