			...
			<div class="card-body">
				...
				<div class="form-group row">
					<table class="table table-bordered">
                        ...
                        <a class="btn btn-warning btn-sm" href="productoDetalle.php">Detalle</a>
				...
				<div class="form-group row">
				<div class="col-lg-2 ">
				<a class="btn btn-danger btn-md" href="homesede.php">Atras</a>
				</div>
				<div class="col-lg-1 ">
				<a class="btn btn-danger btn-md" href="gestionProductos.php">Entradas</a>
				</div>
				</div>
				</form>
