...
<html>
    ...
    <div class="wrapper">
        ...
        <div id="content">
          ...
          <a href="nuevoempleado.php"> <button type="button" class="btn btn-info" >Nuevo Empleado</button> </a>
          
       

                <label for="xnombre">Cedula:</label>
                <input type="text" placeholder="Buscar cedula de empleado   " name="sfechai" class="sfechai"/>
      ...
      <tr>
          ...
          <td></td>
          <td></td>
          <td>  <a href=""> <button type="button" class="btn btn-danger">Eliminar empleado</button> </a></td>
          <td> <a href="editarempleado.php"> <button type="button" class="btn btn-warning">Editar Empleado</button> </a>  </td>
        </tr>
      </tbody>
