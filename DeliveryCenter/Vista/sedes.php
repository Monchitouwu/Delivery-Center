...
<html>
    ...
    <div class="wrapper">
        ...
        <div id="content">
          ...
          <a href="nuevasede.php"> <button type="button" class="btn btn-info" >Nueva sede</button> </a>
          
       

                <label for="xnombre">Nombre de sede:</label>
                <input type="text" placeholder="Buscar nombre de la sede   " name="sfechai" class="sfechai"/>
      ...
      <tr>
          ...
          <td></td>
          <td></td>
          <td>  <a href=""> <button type="button" class="btn btn-danger">Eliminar Sede</button> </a></td>
          <td> <a href="editarsede.php"> <button type="button" class="btn btn-warning">Editar Sede</button> </a>  </td>
        </tr>
      </tbody>
