		...
		<div class="card text-center">
			<div class="card-header">
				<h4 class="factura-titulo"><svg width="1em" height="1em" viewBox="0 -5 19 20" class="bi bi-pencil-square text-danger"
					...
					</svg>Gestion de Productos</h4>
            </div>
            <div class="card-header">
				<h4 class="factura-titulo">Entradas</h4>
			</div>

			<div class="card-body">
				<div class="form-group row">
					<label class="col-lg-1 col-form-label-sm"><strong>Buscar</strong></label>
					<div class="col-lg-2">
                    <form class="form-inline">
  <i class="fas fa-search" aria-hidden="true"></i>
  <input class="form-control form-control-sm ml-3 w-150" type="text" placeholder="Ingrese entrada"
    aria-label="Search">
</form>

</div>
<div class="col-lg-2">
                <a class="btn btn-danger btn-md" href="#">Registrar entrada</a>
</div>
				</div>
				...
				<div class="form-group row">
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								<td class="text-center-sm">02/06/2020</td>
								<td class="text-center">@USUARIOSEDE</td>
                                <td class="text-center">Medio pollo asadp</td>
                                <td class="text-center">$40000</td>
                                <td class="text-center">30</td>
                                <td class="text-center">Monterrey</td>
                            </tr>
                            <tr>
								<td class="text-center-sm">03/04/2020</td>
								<td class="text-center">@USUARIOSEDE</td>
                                <td class="text-center">Porcion de papas</td>
				...
				<div class="form-group row">
				<div class="col-lg-2 ">
				<a class="btn btn-danger btn-md" href="productos.php">Atras</a>
				</div>
				</div>
				</form>
